    ...
    public partial class Validate : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if(!IsPostBack)
            {
                ...
                TimerValidate.Interval = Convert.ToInt32(timerrefreshinterval);
            LoadGroupNames();
            }
        }
               ...
               // if (!IsPageRefresh)
                //{
                    ...
                    else
                    {
                        ...
                        output = rs.StartSmokeTestRunbook(strRunbookPath, strTextPath, txtLogPath, uniqueGUID, "Yes", "Text", "");
                       // System.Threading.Thread.Sleep(25000);
                    }
        ...
        public void CallValidateMethod()
        {
            if (cbNumbers.Checked == true)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //  output = rs.StartRunbookWithParameters(strRunbookPath, strTextPath, txtDomainAccName.Text, txtDomainAcctPwd.Text, "3", txtLogPath, "0", "nope", "Preview", uniqueGUID, hdnFileName.Value, "", "Text");
                    }
                }
            ...
            if (cbSimpleUpdate.Checked == true)
            {
                ...
                try
                {
                    ...
                    if (fupValidateExcel.HasFile)
                    {
                        ...
                        // output = rs.StartRunbookWithParameters(strRunbookPath, hdnExcelPath.Value, "3", txtLogPath, "0", "nope", "preview", uniqueGUID, hdnFileName.Value, "", "Excel", txtOnlyQFE, txtExcludeQFE, rblBPU.SelectedValue.ToString());
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            // output = rs.StartRunbookWithParameters(strRunbookPath, strTextPath, "3", txtLogPath, "0", "nope", "preview", uniqueGUID, hdnFileName.Value, "", "Text", txtOnlyQFE, txtExcludeQFE, rblBPU.SelectedValue.ToString());
            ...
            if (cbMSNPatch.Checked == true)
            {
                ...
                try
                {
                    ...
                    {
                        output = rs.StartValidateRunbook(strRunbookPath, hdnExcelPath.Value, txtLogPath, uniqueGUID, hdnFileName.Value, "Group", ddlValidateNames.SelectedItem.Text);
                    }
                    else
                    {
            ...
            if (cbODP.Checked == true)
            {
                ...
                try
                {
                    ...
                    {
                        output = rs.StartRunbookWithParameters(strRunbookPath, hdnExcelPath.Value, "2", txtLogPath, "0", "nope", "Scan", uniqueGUID, hdnFileName.Value, "", "Group", txtOnlyQFE, txtExcludeQFE, rblBPU, ddlValidateNames.SelectedItem.Text);
                    }
                    else
                    {
                        string[] values = txtValidateServerNames.Text.Split(',');
